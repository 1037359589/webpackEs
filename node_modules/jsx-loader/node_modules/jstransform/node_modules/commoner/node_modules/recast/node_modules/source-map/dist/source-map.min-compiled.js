    ...
    function t(e) {
      ...
      for (var r, t, o, s, u, l = 1, p = 0, h = 0, f = 0, d = 0, m = 0, _ = e.length, v = 0, y = {}, C = {}, A = [], S = []; _ > v;) if (";" === e.charAt(v)) l++, v++, p = 0;else if ("," === e.charAt(v)) v++;else {
        for (r = new i(), r.generatedLine = l, s = v; _ > s && !this._charIsMappingSeparator(e, s); s++);if ((t = e.slice(v, s), o = y[t])) v += t.length;else {
          for (o = []; s > v;) c.decode(e, v, C), u = C.value, v = C.rest, o.push(u);if (2 === o.length) throw new Error("Found a source, but no line and column");if (3 === o.length) throw new Error("Found a source and line, but no column");y[t] = o;
