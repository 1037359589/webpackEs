...
describe('es6ArrowFunctionsTransform', function () {
  ...
  it('should capture correct this value at different levels', function () {
    var code = transform(['var foo = {', '  createFooGetter: function() {', '    return (x) => [x, this];', // captures foo
  ...
  it('should correctly transform arrows', function () {
    ...
    expectTransform('(() => <this />)', '((function()  {return <this />;}.bind(this)))');
  });
});

//# sourceMappingURL=es6-arrow-function-visitors-test-compiled.js.map