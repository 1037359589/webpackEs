  ...
  describe('ClassDeclarations', function () {
    ...
    describe('functional tests', function () {
      ...
      it('properly handles computed static methods', function () {
        var code = transform(['var bar = "foobar";', 'class Foo {', '  static [bar]() {', '    return 42;', '  }', '}'].join('\n'));
      ...
      it('properly handles computed instance methods', function () {
        var code = transform(['var bar = "foobar";', 'class Foo {', '  [bar]() {', '    return 42;', '  }', '}'].join('\n'));
...
//# sourceMappingURL=es6-class-visitors-test-compiled.js.map