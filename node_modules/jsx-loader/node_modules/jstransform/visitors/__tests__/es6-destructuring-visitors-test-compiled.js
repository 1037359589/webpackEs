...
describe('es6-destructuring-visitors', function () {
  ...
  it('should work with rest params', function () {
    ...
    expect(foo({ bar: 10, baz: 20 }, 30)).toEqual({ bar: 10, baz: 20, qux: 30 });
  });
  ...
  it('should work with object concise methods', function () {
    ...
    expect(foo.bar({ x: 10, y: 20 })).toEqual({ x: 10, y: 20 });
  });
  ...
  it('should work with arrows', function () {
    ...
    expect(foo({ x: 10, y: 20 }, 30)).toEqual(60);
  });

  it('should work with arrows without other arguments', function () {
    var code = transform(['var foo = ({x, y}) => x + y;', 'var bar = ([x, y]) => x + y;'].join('\n'));

    eval(code);

    expect(foo({ x: 10, y: 20 })).toEqual(30);
    expect(bar([10, 20])).toEqual(30);
  });
  ...
  it('should allocate correct temp nested index', function () {
    ...
    expect(foo(1, { y: 10 }, { z: 20 })).toEqual([{ y: 10 }, { z: 20 }, { q: 30, m: { v: 40 } }, { v: 40 }, 50]);
  });
...
//# sourceMappingURL=es6-destructuring-visitors-test-compiled.js.map