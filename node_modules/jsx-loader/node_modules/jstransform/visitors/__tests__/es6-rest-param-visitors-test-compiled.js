...
describe('es6-rest-param-visitors', () => {
  ...
  beforeEach(() => {
    ...
    visitorSet = arrowFuncVisitors.concat(classVisitors).concat(restParamVisitors).concat(callSpreadVisitors);
  });
  ...
  describe('function declarations', () => {
    ...
    it('should work with temp var injections', () => {
      ...
      var code = transform(['function test(bar, ...args) {', '  return bar(...args);', '}'].join('\n'));
...
//# sourceMappingURL=es6-rest-param-visitors-test-compiled.js.map