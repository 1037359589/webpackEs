...
function es6ObjectComputedProperties(traverse, node, path, state) {
  ...
  for (var ii = 0; ii < node.properties.length; ++ii) {
    ...
    if (property.type === Syntax.SpreadProperty) {
      ...
      var lastWasSpread = es7SpreadProperties.renderSpreadProperties(traverse, node.properties.slice(ii, nextComputedPropertyIndex), path, state, true // previousWasSpread
      );
...
//# sourceMappingURL=es6-object-computed-property-visitors-compiled.js.map