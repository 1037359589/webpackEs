...
visitFunctionDefinitionArguments.test = function (node, path, state) {
  return (node.type === Syntax.FunctionExpression || node.type === Syntax.FunctionDeclaration || node.type === Syntax.MethodDefinition) && (node.params && node.params.length > 0 || // function expression/declaration
...
//# sourceMappingURL=es7-trailing-comma-visitors-compiled.js.map