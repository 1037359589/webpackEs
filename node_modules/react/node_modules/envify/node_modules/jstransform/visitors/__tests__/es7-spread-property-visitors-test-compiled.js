...
describe('es7-spread-property-visitors', function () {
  ...
  it('coalesces consecutive properties into a single object', function () {
    expectObjectAssign('var xyz = { ...x, y: 2, z: z }').toBeCalledWith({}, x, { y: 2, z: z });
  });
  ...
  it('passes the same value multiple times to Object.assign', function () {
    expectObjectAssign('var xyz = { x: 1, y: 2, ...z, ...z }').toBeCalledWith({ x: 1, y: 2 }, z, z);
  });
...
//# sourceMappingURL=es7-spread-property-visitors-test-compiled.js.map